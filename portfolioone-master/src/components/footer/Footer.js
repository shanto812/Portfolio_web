...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: <FaFacebookF />,
      link: "https://www.facebook.com/hashibul.hassan.shanto.2024/",
      label: "Facebook",
    },
    {
      icon: <FaLinkedinIn />,
      link: "https://www.linkedin.com/in/hasibul-hassan-shanto-b671b1361/",
      label: "LinkedIn",
    },
    {
      icon: <FaGithub />,
      link: "https://github.com/shanto812",
      label: "GitHub",
    },
  ];

  const navItems = ["Home", "Projects", "Features", "Contact"];
      ...
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col items-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-4 mb-12 group">
          <div className="p-3 rounded-full border border-white/5 group-hover:border-[#8b1e2d]/50 transition-all duration-700">
            <img
              className="w-16 grayscale group-hover:grayscale-0 transition-all duration-700 transform group-hover:scale-110"
              src={logo}
              alt="Logo"
            />
          </div>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 gap-6">
          ...
          <button
            ...
            className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#8b1e2d] hover:text-white hover:border-[#8b1e2d] transition-all duration-500 group shadow-lg"
          >
